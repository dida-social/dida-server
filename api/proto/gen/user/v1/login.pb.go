...
const file_user_v1_login_proto_rawDesc = "" +
	"\n" +
	"\x13user/v1/login.proto\x12\auser.v1\"_\n" +
	...
	"\x05token\x18\x03 \x01(\tR\x05token2J\n" +
	"\x10UserLoginService\x126\n" +
	"\x05Login\x12\x15.user.v1.LoginRequest\x1a\x16.user.v1.LoginResponseB\x97\x01\n" +
	"\vcom.user.v1B\n" +
	"LoginProtoP\x01Z?github.com/dida-social/dida-server/api/proto/gen/user/v1;userv1\xa2\x02\x03UXX\xaa\x02\aUser.V1\xca\x02\aUser\\V1\xe2\x02\x13User\\V1\\GPBMetadata\xea\x02\bUser::V1b\x06proto3"

var (
	file_user_v1_login_proto_rawDescOnce sync.Once
	file_user_v1_login_proto_rawDescData []byte
)

func file_user_v1_login_proto_rawDescGZIP() []byte {
	file_user_v1_login_proto_rawDescOnce.Do(func() {
		file_user_v1_login_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_user_v1_login_proto_rawDesc), len(file_user_v1_login_proto_rawDesc)))
	})
	return file_user_v1_login_proto_rawDescData
}

var file_user_v1_login_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_user_v1_login_proto_goTypes = []any{
...
var file_user_v1_login_proto_depIdxs = []int32{
	0, // 0: user.v1.UserLoginService.Login:input_type -> user.v1.LoginRequest
	1, // 1: user.v1.UserLoginService.Login:output_type -> user.v1.LoginResponse
...
func file_user_v1_login_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_user_v1_login_proto_rawDesc), len(file_user_v1_login_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
