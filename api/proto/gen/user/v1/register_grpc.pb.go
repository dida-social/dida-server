...
const (
	UserRegisterService_Register_FullMethodName = "/user.v1.UserRegisterService/Register"
)
...
func (c *userRegisterServiceClient) Register(ctx context.Context, in *RegisterRequest, opts ...grpc.CallOption) (*RegisterResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RegisterResponse)
	err := c.cc.Invoke(ctx, UserRegisterService_Register_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// All implementations should embed UnimplementedUserRegisterServiceServer
// for forward compatibility.
type UserRegisterServiceServer interface {
	Register(context.Context, *RegisterRequest) (*RegisterResponse, error)
}

// UnimplementedUserRegisterServiceServer should be embedded to have
...
func (UnimplementedUserRegisterServiceServer) Register(context.Context, *RegisterRequest) (*RegisterResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Register not implemented")
}
func (UnimplementedUserRegisterServiceServer) testEmbeddedByValue() {}
...
func RegisterUserRegisterServiceServer(s grpc.ServiceRegistrar, srv UserRegisterServiceServer) {
	// If the following call pancis, it indicates UnimplementedUserRegisterServiceServer was
...
func _UserRegisterService_Register_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RegisterRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserRegisterServiceServer).Register(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserRegisterService_Register_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserRegisterServiceServer).Register(ctx, req.(*RegisterRequest))
	}
...
var UserRegisterService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "user.v1.UserRegisterService",
	HandlerType: (*UserRegisterServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Register",
			Handler:    _UserRegisterService_Register_Handler,
		},
	},
